	...
	public function index() { 
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$this->data['categories'][] = array(
					'name'  => $result['name'],
					'count' => $this->config->get('config_product_count') ? $product_total : '',
			...
			foreach ($results as $result) {
				...
				$this->data['products'][] = array(
					...
					'thumb'       => $this->model_tool_image->resize(($image=='' ? 'no_image.png' : $result['image']), $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height')),
					'name'        => $result['name'],
			...
			$limits = array_unique(array($this->config->get('config_catalog_limit'), 300));
