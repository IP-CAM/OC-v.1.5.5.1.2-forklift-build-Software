...
<div class="main-title container">
  <!-- <div class="main-title__name"></div> -->
  <div class="main-title__h1"><h1><?php echo $heading_title; ?></h1></div>
</div>
    ...
    <div class="static-content">
      <p>
        ...
        <div class="s_block">
          ...
          <button id="button-search" class="button_s"><i class="fa fa-search"></i></button>
        </div>
        <?php } else { ?>
        <div class="s_block">
...
<?php echo $footer; ?>
  ...
  <div class="product-list s_result">
